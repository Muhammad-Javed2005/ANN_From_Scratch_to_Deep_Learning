...
This repository focuses on understanding **Artificial Neural Networks (ANN)** from first principles — starting from the **Perceptron model** and gradually moving towards **deep learning concepts** like backpropagation, optimizers, regularization, and dropout.
...
│
├── 01_Percepton.ipynb              # Basic perceptron model
├── 02_Activation_Functions.ipynb   # Sigmoid, ReLU, Tanh, etc.
├── 03_Loss_Functions.ipynb         # MSE, Cross-Entropy
├── 04_Backpropagation.ipynb        # Gradient descent & backprop
├── 05_MLP_Architecture.ipynb       # Multi-Layer Perceptron
├── 06_Weight_Initialization.ipynb  # Xavier, He initialization
│
├── Check_Overfitting.ipynb         # Bias-variance analysis
├── Dropout_Layer.ipynb             # Dropout regularization
├── Regularization.ipynb            # L1 & L2 regularization
├── Optimizer_In_Neural_Nwtwork.ipynb # SGD, Adam, RMSprop
│
├── README.md
└── .gitattributes
```
